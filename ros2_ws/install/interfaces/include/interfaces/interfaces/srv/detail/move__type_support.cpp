...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Move_Request_message_member_array[1] = {
  {
    ...
    offsetof(interfaces::srv::Move_Request, move),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Move_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interfaces::srv::Move_Response, structure_needs_at_least_one_member),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
