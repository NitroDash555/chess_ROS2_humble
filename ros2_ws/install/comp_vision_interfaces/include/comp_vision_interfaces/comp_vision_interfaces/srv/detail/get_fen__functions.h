...
#ifndef COMP_VISION_INTERFACES__SRV__DETAIL__GET_FEN__FUNCTIONS_H_
#define COMP_VISION_INTERFACES__SRV__DETAIL__GET_FEN__FUNCTIONS_H_
...
#include "comp_vision_interfaces/msg/rosidl_generator_c__visibility_control.h"
 ...
 */
ROSIDL_GENERATOR_C_PUBLIC_comp_vision_interfaces
bool
 ...
 * calls
 * comp_vision_interfaces__srv__GetFEN_Request__init().
...
/**
 * It calls
 * comp_vision_interfaces__srv__GetFEN_Request__fini()
 ...
 * comp_vision_interfaces__srv__GetFEN_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * comp_vision_interfaces__srv__GetFEN_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * comp_vision_interfaces__srv__GetFEN_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_comp_vision_interfaces
...
/**
 * It calls
 * comp_vision_interfaces__srv__GetFEN_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_comp_vision_interfaces
...
/**
 * It allocates the memory for the array and calls
 * comp_vision_interfaces__srv__GetFEN_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_comp_vision_interfaces
...
/**
 * It calls
 * comp_vision_interfaces__srv__GetFEN_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // COMP_VISION_INTERFACES__SRV__DETAIL__GET_FEN__FUNCTIONS_H_
